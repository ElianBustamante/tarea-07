<template>
  <div class="navv">
    <span :class="{'navs' : !view_all, 'navs-active' : view_all}" @click="selectNav(1)">VER TODO</span>
    <span :class="{'navs' : !completed, 'navs-active' : completed}" @click="selectNav(2)">COMPLETADO</span>
    <span :class="{'navs' : !ongoing, 'navs-active' : ongoing}" @click="selectNav(3)">EN CURSO</span>
...
export default {
  ...
  setup(){
    ...
    let todos = ref([
      {content: "Tarea ToDoer", inProgress: true, id: 1},
      {content: "Proyecto ISOFT", inProgress: true, id: 2},
      {content: "Comer completos", inProgress: false, id: 3},
    ])
